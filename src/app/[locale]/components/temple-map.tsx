...
const templeLocations: TempleLocation[] = [
  {
    nameKey: "temple_1_name",
    addressKey: "temple_1_address",
  ...
  {
    nameKey: "temple_2_name",
    addressKey: "temple_2_address",
  ...
  {
    nameKey: "temple_3_name",
    addressKey: "temple_3_address",
  ...
  {
    nameKey: "temple_4_name",
    addressKey: "temple_4_address",
  ...
  {
    nameKey: "temple_5_name",
    addressKey: "temple_5_address",
  ...
  {
    nameKey: "temple_6_name",
    addressKey: "temple_6_address",
  ...
  {
    nameKey: "temple_7_name",
    addressKey: "temple_7_address",
  ...
  {
    nameKey: "temple_8_name",
    addressKey: "temple_8_address",
  ...
  {
    nameKey: "temple_9_name",
    addressKey: "temple_9_address",
  ...
  {
    nameKey: "temple_10_name",
    addressKey: "temple_10_address",
  ...
  {
    nameKey: "temple_11_name",
    addressKey: "temple_11_address",
  ...
  {
    nameKey: "temple_12_name",
    addressKey: "temple_12_address",
  ...
  {
    nameKey: "temple_13_name",
    addressKey: "temple_13_address",
  ...
  {
    nameKey: "temple_14_name",
    addressKey: "temple_14_address",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {templeLocations.map((location, index) => (
            <Card key={index} className="overflow-hidden relative">
              <CardHeader>
                <CardTitle>{t(location.nameKey)}</CardTitle>
                <CardDescription>{t(location.addressKey)}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="relative h-64 w-full mb-4">
                  <iframe
                    ...
                    title={t('map_of_name', {name: t(location.nameKey)})}
                  ></iframe>
                </div>
              </CardContent>
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        {t('share_location_description', {name: t(location.nameKey)})}
                      </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
                      <SocialIcons 
                        shareUrl={location.shareMapUrl} 
                        quote={t('share_quote', {name: t(location.nameKey), address: t(location.addressKey)})} 
                        lat={location.lat} 
                        lng={location.lng} 
                      />
                    </div>
