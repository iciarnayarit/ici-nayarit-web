  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      <div className="text-center mb-2">
        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Nuestros Videos</h1>
        ...
        {videos.map((video) => (
          <div key={video.id} className="bg-muted rounded-lg aspect-video overflow-hidden">
            <iframe
              ...
              allowFullScreen
            ></iframe>
            <h2 className="text-lg font-bold text-center mt-2">{video.titleKey}</h2>
          </div>
        ))}
      </div>
    </div>
