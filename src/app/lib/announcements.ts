export const featuredAnnouncement = {
  ...
  description: 'Este viernes nos reuniremos todas las iglesias de la zona para interceder por nuestra comunidad, las familias y el crecimiento espiritual de Jalisco. ¡Tu presencia es vital!',
