...
import { esperanza as planDays } from '@/lib/reading-plan-data/esperanza';
...
export default function EsperanzaPlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-muted-foreground mb-8">
          Encuentra esperanza en las promesas de Dios, sin importar lo que estés enfrentando.
        </p>
