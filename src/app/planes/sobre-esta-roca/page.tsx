...
import { sobreEstaRoca as planDays } from '@/lib/reading-plan-data/sobre-esta-roca';
...
export default function SobreEstaRocaPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        Un estudio sobre la iglesia y su fundamento en Cristo.
        </p>
