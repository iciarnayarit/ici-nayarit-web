...
import { uncommenCorazonesAnsiosos as planDays } from '@/lib/reading-plan-data/uncommen-corazones-ansiosos';
...
export default function UncommenCorazonesAnsiososPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        UNCOMMEN: Corazones Ansiosos
        </h1>
        <p className="text-center text-muted-foreground mb-8">
        Un plan para hombres sobre cómo lidiar con la ansiedad.
        </p>
