...
const planDays = allPlanData['sanidad'];
...
export default function SanidadPlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold font-headline text-center mb-4">
            Plan de Lectura para la Sanidad
        </h1>
        <p className="text-center text-muted-foreground mb-8">
          Descubre el poder de Dios para sanar tu corazón, mente y cuerpo.
        </p>
