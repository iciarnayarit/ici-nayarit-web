...
const planDays = allPlanData['palabra-de-dios'];
...
export default function PalabraDeDiosPlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold font-headline text-center mb-4">
          Plan de Lectura sobre Palabra de Dios (Fundamentos de la Fe)
        </h1>
        <p className="text-center text-muted-foreground mb-8">
          Un plan para conocer los fundamentos de la fe cristiana.
        </p>
