...
import { tierraSanta as planDays } from '@/lib/reading-plan-data/tierra-santa';
...
export default function TierraSantaPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        Un viaje virtual por los lugares santos de la Biblia.
        </p>
