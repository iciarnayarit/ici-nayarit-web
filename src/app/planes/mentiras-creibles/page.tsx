...
const planDays = allPlanData['mentiras-creibles'];
...
export default function MentirasCreiblesPlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold font-headline text-center mb-4">
            Mentiras Creíbles: Un Plan de Lectura de 6 Días
        </h1>
        <p className="text-center text-muted-foreground mb-8">
          Descubre las mentiras que has creído y abrázate a la verdad de Dios.
        </p>
