...
import { inmersionEnIsaias as planDays } from '@/lib/reading-plan-data/inmersion-en-isaias';
...
export default function InmersionEnIsaiasPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        Sumérgete en la riqueza teológica y profética de Isaías.
        </p>
