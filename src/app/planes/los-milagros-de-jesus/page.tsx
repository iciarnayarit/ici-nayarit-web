...
import { losMilagrosDeJesus as planDays } from '@/lib/reading-plan-data/los-milagros-de-jesus';
...
export default function LosMilagrosDeJesusPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        Descubre el poder y la compasión de Jesús a través de sus milagros.
        </p>
