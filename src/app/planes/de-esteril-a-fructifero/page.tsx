...
import { deEsterilAFructifero as planDays } from '@/lib/reading-plan-data/de-esteril-a-fructifero';
...
export default function DeEsterilAFructiferoPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        De Estéril a Fructífero
        </h1>
        <p className="text-center text-muted-foreground mb-8">
        Descubre cómo Dios puede traer fruto a tu vida.
        </p>
