...
import { salvacionUnEstudioEnIsaias as planDays } from '@/lib/reading-plan-data/salvacion-un-estudio-en-isaias';
...
export default function SalvacionUnEstudioEnIsaiasPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        Salvación: Un Estudio en Isaías
        </h1>
        <p className="text-center text-muted-foreground mb-8">
        Profundiza en el tema de la salvación en el libro de Isaías.
        </p>
