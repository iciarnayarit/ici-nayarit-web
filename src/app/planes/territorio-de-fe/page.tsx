...
const planDays = allPlanData['territorio-de-fe'];
...
export default function TerritorioDeFePlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold font-headline text-center mb-4">
          Plan de Lectura sobre Territorio de Fe
        </h1>
        <p className="text-center text-muted-foreground mb-8">
          Un plan para fortalecer tu fe.
        </p>
