...
const planDays = allPlanData['ansiedad'];
...
export default function AnxietyPlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold font-headline text-center mb-4">
            Plan de Lectura para la Ansiedad
        </h1>
        <p className="text-center text-muted-foreground mb-8">
          Encuentra paz y fortaleza en la palabra de Dios.
        </p>
