...
import { aTravesDeLaBibliaIsaias as planDays } from '@/lib/reading-plan-data/a-traves-de-la-biblia-isaias';
...
export default function ATravesDeLaBibliaIsaiasPlanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        Un recorrido completo por el libro de Isaías.
        </p>
