...
const planDays = allPlanData['el-evangelio-de-isaias'];
...
export default function ElEvangelioDeIsaiasPlanPage() {
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-muted-foreground mb-8">
          Explora el libro de Isaías y su mensaje de esperanza y salvación.
        </p>
