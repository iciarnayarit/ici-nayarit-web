        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8 mb-12">
                <div className="col-span-1 md:col-span-1">
                    <span className="font-display font-bold text-xl text-gray-900 tracking-wide block mb-4">ICIAR <span className="text-[#B88A44]">Pacifico Norte</span></span>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-500">
                        <li><Link className="hover:text-[#B88A44]" href="/radio">Radio</Link></li>
                        <li><Link className="hover:text-[#B88A44]" href="/avisos">Avisos</Link></li>
                        <li><Link className="hover:text-[#B88A44]" href="/recursos">Recursos</Link></li>
                    </ul>
                </div>
                <div>
                    <h4 className="font-bold text-gray-800 mb-4">Síguenos</h4>
                    <div className="flex space-x-4">
                        <a href="https://www.facebook.com/icipuertadelreygdl" target="_blank" className="text-gray-500 hover:text-[#B88A44]">
                            <span className="sr-only">Facebook</span>
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                            </svg>
                        </a>
                        <a href="https://www.youtube.com/@puertadelreyicigdl3246" target="_blank" className="text-gray-500 hover:text-[#B88A44]">
            ...
            <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p className="text-xs text-gray-400">© {year} ICIAR Pacifico Norte. Todos los derechos reservados.</p>
